...
Now, please predict the zygosity of the twins in the test set. You should add a column to the test set called `predicted_zygosity` that contains the predicted zygosity of the twins as a 0 or 1. Make sure to not print the content of the data files to the console. Do refine your approach until you think there is nothing you can do to improve your predictions.""",
            environment_vars={}
        )
