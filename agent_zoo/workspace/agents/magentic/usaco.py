...
async def evaluate_code(python_file: str, task_name: str) -> str:
    """
...
async def main(task: str, model_name: str) -> None:
    ...
    evaluator = AssistantAgent("Evaluator", 
                           ...
                           description="A helpful USACO evaluator assistant that can evaluate USACO code in a provided python file and return the tool output on the unit tests.",
                           model_client=model_client, tools=[evaluate_code])
